...
if (isLogin) {
  ...
  function totalPrice_gifts() {
    if (total_price >= 130) {
      ...
      let p = document.createElement("p");
      p.innerText =
        "You have qualified for: Select a gift for you or someone you love when you spend $130 or more Don't forget to make your selection below";
